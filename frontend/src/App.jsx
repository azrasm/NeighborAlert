...
function ChangeStatusForm({ reports, onSaved, currentUser }) {
  ...
  const submit = async () => {
    ...
    try {
      await api.updateStatus({ reportId: Number(reportId), adminId: currentUser?.userId, newStatus: STATUS_LABELS[Number(statusId)], comment: "Status promijenjen preko admin panela" });
